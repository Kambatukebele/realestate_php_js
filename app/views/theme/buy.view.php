...
<!-- END HEADER  -->
<!-- HERO -->
<section class="heroBuy">
  <div class="heroBuy__wrapper">
    <div class="heroBuy__text">
      <h1 class="heroBuy__title">Find Your Dream Home</h1>
    </div>
  </div>
</section>
<!-- END HERO -->
<!--SEARCH  -->
<section class="searchBuy">
  <div class="searchBuy__wrapper">
    <form class="searchBuy__form" method="GET">
      <div class="searchBuy__input">
        <span class="material-symbols-outlined">
          search
        </span>
        <input type="text" placeholder="City, Adress, Zip">
      </div>
      <div class="searchBuy__btn">
